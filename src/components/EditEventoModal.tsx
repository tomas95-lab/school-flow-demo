...
export default function EditEventoModal({ open, onOpenChange, onSuccess, eventoId, eventoData }: EditEventoModalProps) {
  ...
  useEffect(() => {
    if (eventoData && open) {
      setFormData({
        ...
        courseId: eventoData.courseId || "",
        subjectId: eventoData.subjectId || "",
        allDay: eventoData.allDay !== undefined ? eventoData.allDay : true
      });
    }
  }, [eventoData, open]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Modifica los detalles del evento. Los campos marcados con * son obligatorios.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked: boolean) => setFormData({ ...formData, allDay: checked })}
            />
